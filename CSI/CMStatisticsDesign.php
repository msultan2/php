                        ...
                        <table id="grid2" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true" data-keep-selection="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="Total_SPEECH_TRAFFIC_KErlg" data-visible="true" sortable="true" header-css-class="cbg-header-name">CRQ_Desc</th>
                                    ...
                                    <th data-column-id="DATA_GB"  data-visible="false" sortable="true">DATA_GB</th>
                            ...
                            foreach ($Table2ArrayResult as $i => $values) {
								  ...
								  // echo '<td>'.$i.'</td>';
								    foreach ($values as $key => $value) {
								       echo '<td class="multilineCell">'.$value.'</td>';
								    }
								    echo '</tr>';
								}
?>
...
$("#RegionAnalysisShow").css("visibility","hidden");
				...
				$( ".column-header-anchor span" ).removeClass( "text" );
				
				//$( "td" ).removeClass( "text-left" );
				//$( "td" ).addClass( "multilineCell" );	alert("rrrrrr2");
</script>
