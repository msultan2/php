...
<div class="container-fluid">
        ...
        <div class="row">
  <div class="col-md-11">
  <h6 style="font-size: 40px;text-align: center;"> BSS Activity Card (<?php  echo $CRQ ;?>)</h6>
  </div>
...
<div class="row">
  ...
  <div class="col-md-11"><h6 style="font-size: 20px;text-align: center;"> 
                        ...
                        <table id="grid" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true" data-keep-selection="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="impactedsites" data-type="numeric" data-visible="true"># Impacted Sites</th>
                                    <th data-column-id="totalsitesperarea" data-type="numeric" data-visible="true">Total Sites per area</th>
                                    <th data-column-id="areaimpactpercentage" data-type="numeric" data-visible="true">Area Impact %</th>
                                    <th data-column-id="status" data-type="numeric" data-visible="false">Status</th>
                        ...
                        <table id="grid2" class="table table-condensed table-hover table-striped" data-selection="true" data-multi-select="true" data-row-select="true" data-keep-selection="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-column-id="impactedsites2" data-type="numeric" data-visible="true"># Impacted Sites</th>
                                    <th data-column-id="totalsitesperarea2" data-type="numeric" data-visible="true">Total Sites per area</th>
                                    <th data-column-id="areaimpactpercentage2" data-type="numeric" data-visible="true">Area Impact %</th>
                                    <th data-column-id="status2" data-type="numeric" data-visible="false">Status</th>
