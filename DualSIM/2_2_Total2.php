...
$sql=mysql_query("select count(distinct(IMSI1)) as Count, Hour from Final where Date='$date' group by Hour");
...
//end of new addition/////////////////////////////////////////////////
$title="Distinct Number of a Single Pair of Duals in $date ";
