...
$sql=mysql_query("select Hour, `Desc` as `Desc` ,sum(Count) counts FROM (SELECT Hour,`Desc`, Count FROM TWOSIM_2G WHERE Date = '$date' and `Desc` like '%2 SIMs in One Mobile'  union All select Hour,`Desc`, Count FROM TWOSIM_3G WHERE Date = '$date' and `Desc` like '%2 SIMs in One Mobile' ) X GROUP BY `Hour`");
...
//end of new addition/////////////////////////////////////////////////
$title="Number of Total [2/1] Duals in $date ";
