...
$chart=$r1;
Print '<img src="3G_Bar.php?date=' . $date . '&hour=' . $hour . '&chart='. $chart .'" id="imggg">';}
else
{
$date=$date1;
...
$chart=$r1;
Print '<img src="3G_TotalDay_Bar.php?date=' . $date . '&chart='. $chart .'" id="imggg">';}
...
$chart=$r1;
Print '<img src="From_to_3GS.php?datef=' . $datef . '&datet=' . $datet . '&chart='. $chart .'" id="imggg">';  }
