...
$chart=$r1;
Print '<img src="Handsets_Bar_2G.php?date=' . $date . '&hour=' . $hour . '&chart='. $chart .'" id="imggg">';}
else
{
$date=$date1;
...
if ($date!="" and $hour!="" and $date!='Date' and $hour!='Hour'){
$chart=$r2;
Print '<img src="Handsets_Dual_PIE_2G.php?date=' . $date . '&hour=' . $hour . '&chart='. $chart .'" id="imggg">';}
else
{
$date=$date1;
...
$chart=$r1;
Print '<img src="Handset_TotalDay_Bar_2G.php?date=' . $date . '&chart='. $chart .'" id="imggg">';}
...
$chart=$r1;
Print '<img src="Handset_From_to_Combo_2G.php?datef=' . $datef . '&datet=' . $datet . '&chart='. $chart .'" id="imggg">';  }
