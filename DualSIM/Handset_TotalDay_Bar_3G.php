...
$sql=mysql_query("select Hour,substr(`Desc`,32,7) as `Desc` ,Count from DUAL_3G where  Date='$date' and `Desc` like 'Number of Dual Handsets in the Network%' order by Hour");
