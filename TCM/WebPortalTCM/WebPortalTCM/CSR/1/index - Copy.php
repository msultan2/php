...
<head>
    ...
    <title>CSR Tracking System</title>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="sidebar-menu">
                    ...
                    <div class="logo-wrapper">
                        <h1 class="logo">
                            <img src="images/CSR_logo3.png" alt="CSR Tracking System">
                            <span>Create and Track your CSRs</span>
                        </h1>
                    </div> <!-- /.logo-wrapper -->
                    ...
                    <div class="menu-wrapper">
                        <ul class="menu">
                            ...
                            <li><a class="show-4" href="#" onclick="templatemo_map();">New CSR</a></li>
                            <li><a class="show-3" href="#">Search CSR</a></li>
                        </ul> <!-- /.menu -->
    ...
    <div class="container-fluid">   
        <div class="row">
            <div class="col-md-12 footer">
                <p class="footer-text">Copyright &copy; 2014 <a href="http://www.vodafone.com.eg/">Vodafone Egypt</a> - CSR Tracking System by Sara Nabil - Photos by <a rel="nofollow" href="http://unsplash.com">Unsplash</a></p>
            </div><!-- /.footer --> 
        </div>
    </div> <!-- /.container-fluid -->
