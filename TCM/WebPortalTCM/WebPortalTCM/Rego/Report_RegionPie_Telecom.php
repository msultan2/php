<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT CASE SS.Region WHEN 'Alexandria' THEN 'Alex' WHEN 'Upper Egypt' THEN 'Upper' ELSE SS.Region END Region, COUNT(*) TTcount				  
					...
					WHERE tt.Tier1 ='Telecom'
					GROUP BY CASE SS.Region WHEN 'Alexandria' THEN 'Alex' WHEN 'Upper Egypt' THEN 'Upper' ELSE SS.Region END
					ORDER BY 2 DESC;";
...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		...
		//drawPieChart
		var options = {           title: 'Telecom TTs per Region'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
