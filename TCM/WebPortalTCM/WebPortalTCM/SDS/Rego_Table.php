...
<?php	  
		...
		foreach ($data_area as $area) {
			//if($date==$thisDate){            
					...
					echo "<tr><td><a class=area_link href='Report_Area.php?area=$strArea' target='_blank'>".substr($area,0,13)."</a></td>";
					if (isset($data_2G_Per_DownSites[$area])) {
						if($data_2G_Per_DownSites[$area] <= 100 && $data_2G_Per_DownSites[$area] >= 97) $severity = "green";
						if($data_2G_Per_DownSites[$area] <= 96 && $data_2G_Per_DownSites[$area] >= 94 ) $severity = "yellow";
						if($data_2G_Per_DownSites[$area] <= 93 && $data_2G_Per_DownSites[$area] >= 87 ) $severity = "orange";
						if($data_2G_Per_DownSites[$area] <= 86 && $data_2G_Per_DownSites[$area] >= 75 ) $severity = "red";
					...
					if (isset($data_3G_Per_DownSites[$area])) {
						if($data_3G_Per_DownSites[$area] <= 100 && $data_3G_Per_DownSites[$area] >= 97) $severity = "green";
						if($data_3G_Per_DownSites[$area] <= 96 && $data_3G_Per_DownSites[$area] >= 94 ) $severity = "yellow";
						if($data_3G_Per_DownSites[$area] <= 93 && $data_3G_Per_DownSites[$area] >= 87 ) $severity = "orange";
						if($data_3G_Per_DownSites[$area] <= 86 && $data_3G_Per_DownSites[$area] >= 75 ) $severity = "red";
