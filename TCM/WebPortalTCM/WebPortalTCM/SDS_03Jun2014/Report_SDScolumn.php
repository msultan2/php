...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		...
		var dataTable = google.visualization.arrayToDataTable([           
			['Region', '2G','3G','Total'],           //,  { role: 'annotation' }
			<?php for($i=0;$i<count($data_Desc); $i++) {             
						echo "['".$data_Desc[$i]."',".$data_Val_2G[$i].",".$data_Val_3G[$i].",".($data_Val_2G[$i]+$data_Val_3G[$i])."]"; 
						if ($i<count($data_Desc)-1) echo ",";	//add ',' to all except last element
					}  //&cht=p3
				echo ",['Total',".$sum2G.",".$sum3G.",".($sum2G+$sum3G)."]";
			?>
			] ); 
		//drawTable
	...
	<table ><tr>
		...
		<td ><div id="table_div" style="width: 270px; height: 230px;" ></div>  </td>
	</tr></table>
