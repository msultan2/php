					...
					<section class="st-panel st-color" id="st-panel-1">
						...
						<!--p>Banksy adipisicing eiusmod banh mi sed. Squid stumptown est odd future nisi, commodo mlkshk pop-up adipisicing retro.</p-->
							<table align=center>
								...
								<tr>
									<td><iframe src="Rego.php?type=2G" frameborder=0 scrolling=no width="800px" height="490px"></iframe></td>
									<td><iframe src="Rego.php?type=3G" frameborder=0 scrolling=no width="800px" height="490px"></iframe></td>
								</tr>
								<tr>
									<td colspan=2 valign=top><iframe src="Rego_Table_file.php" frameborder=0 scrolling=no width="100%" height="70px"></iframe></td>
								</tr>
								<tr valign=top>
					...
					<section class="st-panel st-color" id="st-panel-3">
						...
						<!--p>Banksy adipisicing eiusmod banh mi sed. Squid stumptown est odd future nisi, commodo mlkshk pop-up adipisicing retro.</p-->
							<table align=left>
								...
								<tr>
									<td colspan=4><iframe src="Report_SDScolumn.php" frameborder=0 scrolling=no width="1250px" height="230px"></iframe></td>
									<td rowspan=2 valign=top><iframe src="Report_SDSbar.php" frameborder=0 scrolling=no width="500px" height="500px"></iframe></td>
								</tr>
								<tr>
									...
									<td><iframe src="Report_DownDaysPie.php?days=60" frameborder=0 scrolling=no width="300px" height="500px"></iframe></td>
								</tr>
							</table>
					</section>
