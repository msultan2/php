				...
				<div class="st-scroll">
					...
					<section class="st-panel st-color" id="st-panel-1">
						...
						<!--p>Banksy adipisicing eiusmod banh mi sed. Squid stumptown est odd future nisi, commodo mlkshk pop-up adipisicing retro.</p-->
							...
							<tr>
								<td valign=top><iframe src="Rego_ShortTable.php?region=Cairo_West" frameborder=0 scrolling=no width="270px" height="100px"></iframe></td>
								<td valign=top><table><tr><td><iframe src="Rego_ShortTable.php?region=Giza" frameborder=0 scrolling=no width="270px" height="100px"></iframe></td></tr>
										<tr><td><iframe src="Rego_ShortTable.php?region=Cairo_East" frameborder=0 scrolling=no width="270px" height="100px"></iframe></td></tr>
								</table></td>
								<td valign=top><table><tr><td><iframe src="Rego_ShortTable.php?region=Alexandria" frameborder=0 scrolling=no width="250px" height="100px"></iframe></td></tr>
										<tr><td><iframe src="Rego_ShortTable.php?region=Canal_Sinai" frameborder=0 scrolling=no width="250px" height="400px"></iframe></td></tr>
								</table></td>
								<td valign=top ><iframe src="Rego_ShortTable.php?region=Canal_Red" frameborder=0 scrolling=no width="270px" height="100px"></iframe></td>
								<td valign=top ><iframe src="Rego_ShortTable.php?region=Delta" frameborder=0 scrolling=no width="260px" height="100px"></iframe></td>
								<td valign=top ><iframe src="Rego_ShortTable.php?region=Upper" frameborder=0 scrolling=no width="250px" height="100px"></iframe></td>
							</tr>
						</table>
					</section>
						...
						<!--p>Banksy adipisicing eiusmod banh mi sed. Squid stumptown est odd future nisi, commodo mlkshk pop-up adipisicing retro.</p-->
							<table align=left>
								...
								<tr>
									...
									<td><iframe src="Report_DownDaysPie.php?days=60" frameborder=0 scrolling=no width="350px" height="500px"></iframe></td>
								</tr>
							</table>
					</section>
						...
						<!--p>Banksy adipisicing eiusmod banh mi sed. Squid stumptown est odd future nisi, commodo mlkshk pop-up adipisicing retro.</p-->
							<table align=center>
								...
								<tr>
									...
									<td valign=right><iframe src="Rego_Giza_Map2.php" frameborder=0 scrolling=no width="2000px" height="1000px"></iframe></td>
								</tr>
							</table>
					</section>
