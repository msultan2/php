			...
			<div class="nav-tabs-custom">
					<!-- Morris chart - Sales -->
						<table><tr><td width=50%>
							...
							<table height=800px><tr align=center><td colspan=2><iframe src="Report_SLA_Guage.php" height=180px width=700px frameborder=0 scrolling=no></iframe></td></tr>
								<tr><td colspan=2>
								...
								<tr><td width=20px>&nbsp;</td>
									<td>
										<h2><center>Sites Grade Compliance</center></h2>
										...
										<!--iframe src="Report_SLA_Access_Scattered_bars.php"  height=200px width=720px frameborder=0 scrolling=no></iframe></td></tr>
							</table>
							</td>
								<td width=50%>
