...
<?php	  
	...
	if (isset($_GET['team'])) {
		...
		$sql = "SELECT vio.Incident_ID,vio.Assigned_Group,CAST(vio.last_modified_date AS Varchar)last_modified_date,vio.Outage,vio.Status,vio.Region,vio.Sub_Region,vio.Priority,CAST(vio.[Submit Date] AS Varchar)Submit_Date,vio.SiteID,vio.TRUs_Affected,TT.Grade,
