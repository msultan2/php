...
<?php
		...
		$sql = "SELECT TT.Incident_ID,TT.Assigned_Group,CAST(TT.last_modified_date AS Varchar)last_modified_date,TT.Outage,TT.Status,TT.Region,TT.Sub_Region,TT.Priority,CAST(TT.[Submit Date] AS Varchar)Submit_Date,TT.SiteID,TT.TRUs_Affected,TT.Outage_Site,TT.Grade,
