...
<?php
		...
		$sql = "SELECT  CASE WHEN TT.NoOfSites >= 100 THEN 'Red'
							WHEN TT.NoOfSites >= 50 THEN 'Orange'
							WHEN TT.NoOfSites >= 10 THEN 'Yellow'
							WHEN TT.NoOfSites < 10 THEN 'Blue'
							END Severity, 
						CASE WHEN TT.NoOfSites >= 100 THEN 1
							WHEN TT.NoOfSites >= 50 THEN 2
							WHEN TT.NoOfSites >= 10 THEN 3
							WHEN TT.NoOfSites < 10 THEN 4
							END Severity_Order, 
						  ...
						  GROUP BY CASE WHEN TT.NoOfSites >= 100 THEN 'Red'
							WHEN TT.NoOfSites >= 50 THEN 'Orange'
							WHEN TT.NoOfSites >= 10 THEN 'Yellow'
							WHEN TT.NoOfSites < 10 THEN 'Blue'
							END, 
...
<script type="text/javascript">       
   ...
   /*['Label', 'Value'],           ['Memory', 80],           ['CPU', 55],           ['Network', 68] */		
	...
	<table ><tr>
		<td colspan=2><div id="chart_div" style="width: 700px; height: 200px; float: middle"></div>  </td></tr>
		<tr><td width=25px>&nbsp;</td><td ><div id="table_div" style="width: 650px; height: 200px; float: middle"></div></td>
	</tr></table>
