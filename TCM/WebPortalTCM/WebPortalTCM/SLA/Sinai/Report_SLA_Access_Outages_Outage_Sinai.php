...
<?php
		...
		$sql = "SELECT  CASE WHEN TT.Priority = 'P1' THEN 'Red'
							WHEN TT.Priority = 'P2' THEN 'Orange'
							WHEN TT.Priority = 'P3' THEN 'Yellow'
							WHEN TT.Priority = 'P4' THEN 'Blue'
							END Severity, 
						CASE WHEN TT.Priority = 'P1' THEN 1
							WHEN TT.Priority = 'P2' THEN 2
							WHEN TT.Priority = 'P3' THEN 3
							WHEN TT.Priority= 'P4' THEN 4
							END Severity_Order, 
						...
						WHERE TT.Outage = 'Yes'
						 AND TT.Region like '%Sinai%'
						  ...
						  GROUP BY CASE WHEN TT.Priority = 'P1' THEN 'Red'
							WHEN TT.Priority= 'P2' THEN 'Orange'
							WHEN TT.Priority = 'P3' THEN 'Yellow'
							WHEN TT.Priority = 'P4' THEN 'Blue'
							END, 
...
<script type="text/javascript">       
   ...
   /*['Label', 'Value'],           ['Memory', 80],           ['CPU', 55],           ['Network', 68] */		
	...
	<table ><tr>
		<td><div style="background-color:white; id="chart_div" style="width: 700px; height: 200px; float: middle"></div>  </td></tr>
		<tr><td ><div style="background-color:white; id="table_div" style="width: 650px; height: 200px; float: middle"></div></td>
	</tr></table>
