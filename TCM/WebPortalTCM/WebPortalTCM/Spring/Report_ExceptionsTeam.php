<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT Support_Company,count(*) CRQnum 
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		var data = google.visualization.arrayToDataTable([           
			['Requesting Department', 'Exceptions'],           
		...
		//drawPieChart
		var options = {           title: 'Exceptions'  , is3D: true  , chartArea:{left:20,top:20,width:"65%",height:"90%"} };          
