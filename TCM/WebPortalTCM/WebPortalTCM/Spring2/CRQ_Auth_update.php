<?php
	...
	$stringData = $stringData . "|" . $CRQ ."|Auth=". $if_Auth . "|new_comment=".$new_comment;
	...
	{
		//Already Exists
		$sql = "UPDATE dbo.tbl_Change_Daily_CAB_Authorize SET Authorized =".$if_Auth." , CM_Comment = '".$new_comment."' WHERE CRQ = '".$CRQ."';";
	...
	else
	{
		 $sql = "INSERT INTO dbo.tbl_Change_Daily_CAB_Authorize (CRQ , Authorized, CM_Comment, User_Updating, Auth_Date)
					VALUES ('".$CRQ."',".$if_Auth.",'".$new_comment."','not me', '". date('m/d/Y H:i:s')."' );";
		 sqlsrv_query( $conn, $sql);
		 echo "inserted";
