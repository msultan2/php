...
<table width="100%"><tr>
	<td>
		...
		<td align=right >
		<?php 
				$sql = "select cab.CRQ,Description,Justification,Support_Organization,Assignee_Group,Status,Impact,cab.DWH_Impact,External_Customer,Internal_Customer,cab.Nodes_Systems from dbo.vw_Change_Daily_CAB cab,dbo.tbl_Change_Daily_CAB_Authorize auth where cab.CRQ = auth.CRQ and ChangeFor = 'Network' And Authorized = '1';";
