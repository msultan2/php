...
<table>	
		<tr colspan=3>
			<td valign=top colspan=3><iframe src="Report_SuppTeam_Search_Changes.php?team=<?php echo str_replace(" ","__",$team);?>&from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" frameborder=0 width="1600px" height="<?php echo 400+(30*($monthCount+4)); ?>px"></iframe></td>
		</tr>
</table>
