	...
	<div id="temmplatmeo_header_ann">
		<div id="templatemo_menu_ann">
			<ul>
                ...
                <li><a href="Calendar_PA.php" class="current">PA Calendar</a></li>
 ...
 <div id="templatemo_banner_ann">
   	<div id="banner_left_ann">   
		<h3>Planned Activities Calendar:</h3>
			<table class=blue width=100% align=center >
			<?php	  
				$prm= $_REQUEST['prm'];
				$chm= $_REQUEST['chm'];
				if(isset($prm)){
				...
				echo " <table class=blue width=100% >";
				...
				for($i=1;$i<=$no_of_days;$i++){
					...
					for($pa=0; $pa < $num_PA; $pa++){
						...
						if($date==$thisDate){
							if($pa_type=='PA'){
								echo "<table class=blue width=100% align=center >";						
