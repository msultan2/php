...
/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT ISNULL(ChangeFor,'Not Specified') ChangeFor,count(*) CRQnum FROM dbo.vw_Change_Approval_Details GROUP BY ChangeFor ORDER BY CRQnum DESC;";
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Changes For'  , is3D: true  , chartArea:{left:0,top:20,width:"90%",height:"90%"} };          
