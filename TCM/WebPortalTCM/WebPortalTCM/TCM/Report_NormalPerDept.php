...
<script type="text/javascript">       
	...
	function drawAll() {         
		...
		//drawPieChart
		var options = { title: 'Normal Scheduled Changes'  ,  chartArea:{left:30,top:30,width:"70%",height:"70%"}, vAxis: {gridlines:{count:8}}, //maxValue:3, minValue:1},
...
<table >
	<tr><td width="350px" class="iframe_td"><div id="chart_div" style="width: 450px; height: 400px;"></div>  </td></tr>
</table>
