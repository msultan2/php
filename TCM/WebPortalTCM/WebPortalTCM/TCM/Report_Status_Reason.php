...
/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT ISNULL(Status_Reason,'Not Specified') Status_Reason, count(*) CRQnum
		...
		while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
			array_push($data_Desc,$row['Status_Reason']);
...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		var data = google.visualization.arrayToDataTable([           
			['Closure Status', 'Number of Changes'],           
		...
		//drawPieChart
		var options = {           title: 'Status Reason of Closed Changes'  , is3D: true  , chartArea:{left:0,top:20,width:"90%",height:"90%"} };          
		var chart = new google.visualization.PieChart(document.getElementById('chart_div'));         
		chart.draw(data, options);       
	} 
</script>   
	<table ><tr>
		<td><div id="chart_div" style="width: 350px; height: 250px;"></div>  </td>
	</tr>
</table>
