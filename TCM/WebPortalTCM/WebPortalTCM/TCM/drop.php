...
$table = 'dbo.tbl_Change_Tiers_Type';
$ar_cols = array('Change_For','Product_Categorization_Tier_1','Product_Categorization_Tier_2','Product_Categorization_Tier_3','Change_Type');
...
//echo $col;
  while($row = sqlsrv_fetch_array( $result, SQLSRV_FETCH_ASSOC)) {
    ...
    if($col==$ar_cols[$last_key]) $re_html .= '<br/>This change is <left>'. $row[$col];
