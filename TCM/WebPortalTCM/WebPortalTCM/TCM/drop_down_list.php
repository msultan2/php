...
$table = 'vw.Change_Approval_Details';
$ar_cols = array('Change_For','Product_Categorization_Tier_1','Product_Categorization_Tier_2','Product_Categorization_Tier_3','Infrastructure_Change_ID');
...
//if ($result->num_rows > 0) {
  ...
  if($col!=$ar_cols[$last_key]) $re_html = $col. ':<br> <select name="'. $col. '"'. $onchg. '><option>- - -</option>';
//echo $col;
