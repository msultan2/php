...
<div id="templatemo_wrapper_ann">
	<div id="temmplatmeo_header_ann">
		<div id="templatemo_menu_ann">
           <ul>	   
				...
				<li><a href="ireport.php" >Monthly Trends</a></li>
				<li><a href="ireport2.php" class="current">Status</a></li>
 ...
 <div id="templatemo_banner_ann">
   	<div id="banner_left_ann">
        <b><h3>Changes Status Per Department:</h3></b>			
		<table>
			<tr>
				<td>
					<iframe  class="iframe_td" width="950px" height="450px" seamless src="Report_Status.php" frameborder="0" ></iframe>
				</td>
			</tr>
		</table>
	</div>
