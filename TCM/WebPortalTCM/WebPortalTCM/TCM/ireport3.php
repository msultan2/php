	...
	<div id="temmplatmeo_header_ann">
		<div id="templatemo_menu_ann">
           <ul>	   
				...
				<li><a href="ireport3.php" class="current">Statistics</a></li>
            </ul>    	    
 ...
 <div id="templatemo_banner_ann">
   	<div id="banner_left_ann">
		...
		<table>
			<tr>
				<td>
					<iframe  class="iframe_td" width="750px" height="550px" seamless src="Report_Statistics.php" frameborder="0" ></iframe>
				</td>
			</tr>
		</table>
	</div>
