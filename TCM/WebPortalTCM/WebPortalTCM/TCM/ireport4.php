...
<div id="templatemo_wrapper_ann">
	<div id="temmplatmeo_header_ann">
		<div id="templatemo_menu_ann">
           <ul>	   
                 <li><a href="ireport4.php" class="current">Weekly Trends</a></li>
 ...
 <div id="templatemo_banner_ann">
   	<div id="banner_left_ann">
        <b><h3>Statistics:</h3></b>			
		<table>
			<tr>
				<td>
					<iframe  class="iframe_td" width="850px" height="500px" seamless src="Report_Normal_week.php" frameborder="0" ></iframe>
				</td>
			</tr>
		</table>
	</div>
