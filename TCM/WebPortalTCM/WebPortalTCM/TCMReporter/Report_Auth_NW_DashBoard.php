...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		var data = google.visualization.arrayToDataTable([           
			...
			?>	] );       
		var options = { title: 'NW CRQs Authorization Status' , hAxis:{slantedText:true} , chartArea:{left:40,top:30,width:"90%",height:"65%"} , selectionMode:'multiple',
						'isStacked':true, colors:['royalblue','green'] ,legend:{position:'bottom'}};          
