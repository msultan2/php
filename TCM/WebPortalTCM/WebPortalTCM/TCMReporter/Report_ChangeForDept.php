<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT Support_Company,count(*) CRQnum FROM dbo.vw_Change_Approval_Details 
				...
				GROUP BY Support_Company ORDER BY CRQnum DESC;";
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Normal Authorized Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"65%",height:"90%"} };          
