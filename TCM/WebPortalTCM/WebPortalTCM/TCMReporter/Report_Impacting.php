		...
		$connectionInfo = array( "UID"=>$ini_array['DB_USER'],
			...
			if( !$conn ) {
				...
				$sql = "SELECT DISTINCT ch.CRQ,Requester,ch.Support_Company,ch.Support_Organization,ch.Support_Group_Name,tsk.Assignee_Company , tsk.Assignee_Organization, tsk.Assignee_Group,
							Description,Justification,Risk_Description,Status, CAST(ch.Scheduled_Start_Date AS varchar) Scheduled_Start_Date,CAST(ch.Scheduled_End_Date AS varchar) Scheduled_End_Date,Impact ,Approval_Pending, ChangeFor,
						...
						WHERE 
						 (External_Customer IS NOT NULL OR Internal_Customer IS NOT NULL OR Nodes_Systems IS NOT NULL OR Reporting IS NOT NULL
