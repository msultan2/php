...
<?php 
	...
	//echo $_GET['from']." ".$startDate;
	
	//$dept = ''; Support_Company IN ('Products & Services Delivery','IT Operations')
...
<?php // content="text/plain; charset=utf-8"
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT YEAR(inc.[Start Date]) year_,MONTH(inc.[Start Date]) month_,count(*) CRQnum
				...
				AND Category NOT IN ('Core Network','Voice','GPRS','Fixed Network','Coverage')
