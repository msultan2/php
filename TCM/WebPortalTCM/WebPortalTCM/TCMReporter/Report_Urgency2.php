<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT Urgency, count(*) CRQnum
...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		var data = google.visualization.arrayToDataTable([           
			['Urgency Level', 'Number of Changes'],           
		...
		//drawPieChart
		var options = {           title: 'Urgency Levels of Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
