...
<div class="body_text" style="color:darkred;"><b>Regional Operations Teams KPIs</b></div><BR>
...
<form method=post action='Reporter_TeamKPIs_RO.php'>
...
?>
	<table>	
		<tr colspan=3>
			<td valign=top colspan=3><iframe src="Report_Team_KPI_RO.php?team=<?php echo str_replace(" ","__",$team);?>&from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" frameborder=0 width="1200px" height="<?php echo 400+(30*($monthCount+4)); ?>px"></iframe></td>
		</tr>
		<tr>
			<td valign=top><iframe src="Report_KPIExceptionsTier_RO.php?team=<?php echo str_replace(" ","__",$team);?>&from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" scrolling=no frameborder=0 width="550px" height="400px"></iframe></td>
			<td valign=top><iframe src="Report_KPIFixTier_RO.php?team=<?php echo str_replace(" ","__",$team);?>&from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" scrolling=no frameborder=0 width="450px" height="400px"></iframe></td>
			<td valign=top><iframe src="Report_KPIIDCType_dept.php?dept=RO&team=<?php echo str_replace(" ","__",$team);?>&from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" scrolling=no frameborder=0 width="450px" height="400px"></iframe></td>
		</tr>
	</table>
