...
<form method=post action='Report_Interval.php'>
...
<?php 
	...
	//if(isset($_POST['submit'])) {
		...
		$sql = $sql. " WHERE dbo.dateOnly(ch.Scheduled_Start_Date) BETWEEN '".$getFrom."' AND '".$getTo."' ";//'4/1/2013' AND '4/12/2013';";
