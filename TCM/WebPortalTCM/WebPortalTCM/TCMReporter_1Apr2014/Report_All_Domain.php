...
<script type="text/javascript">       
	...
	var dataTable = google.visualization.arrayToDataTable([  
		...
		//drawPieChart
		var options = { title: 'Trend of All Changes (Normal+Standard) per Domain'  ,  chartArea:{left:40,top:40,width:"80%",height:"75%"}, vAxis: {gridlines:{count:6}}, //maxValue:3, minValue:1},
						hAxis: {title: 'Number of Changes over time', titleTextStyle: {color: 'red'},  gridlines:{count:6}} 
