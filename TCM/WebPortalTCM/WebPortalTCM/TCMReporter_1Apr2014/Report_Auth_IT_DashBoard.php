...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		var data = google.visualization.arrayToDataTable([           
			...
			?>	] );       
		var options = { title: 'IT CRQs Authorization Status' , hAxis:{slantedText:true} , chartArea:{left:40,top:30,width:"60%",height:"70%"} , 'isStacked':true, colors:['royalblue','green'] };          
