...
/* Specify the server and connection string attributes. */
		...
		//$i = 0; 
		$j=1;
		//WHERE CM_Eval_Approver = '".$approver."'
		//WHERE CM_Eval_Approver = 'SNabil2'
		//foreach ($array_approvers as &$approver) {
		for ($i=0; $i < 3; $i++) { 
		...
		//print_r($data_ASalama8);
		//print_r($data_MShaarawy3);
		//print_r($data_SNabil2);
