...
<script type="text/javascript">       
	...
	function drawAll() {         
		...
		var options_temp = { title: 'IT Emergency Changes Trend'  ,  chartArea:{left:40,top:40,width:"75%",height:"65%"},vAxis: {gridlines:{count:8}}, //maxValue:3, minValue:1},
