<?php
		...
		$sql = "SELECT isnull(inc.Severity,'No Severity') Severity, count(*) INCnum
...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		var data = google.visualization.arrayToDataTable([           
			['Severity of Incident', 'Number of IDCs'],           
		...
		//drawPieChart
		var options = {           title: 'NW IDCs Severity'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
