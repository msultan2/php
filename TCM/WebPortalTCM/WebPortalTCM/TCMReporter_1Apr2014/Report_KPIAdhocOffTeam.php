<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT CASE WHEN Support_Company = 'Regional Operations' THEN Support_Company ELSE Support_Organization END Support_Organization,count(*) CRQnum 
				FROM  dbo.vw_Change_Approval_Details
				WHERE CRQ_Type = 'Standard' AND Status NOT IN ('Request For Authorization','Cancelled','Rejected')
				...
				GROUP BY CASE WHEN Support_Company = 'Regional Operations' THEN Support_Company ELSE Support_Organization END
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Adhoc Off Process Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"60%",height:"90%"} };          
