...
<?php // content="text/plain; charset=utf-8"
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT YEAR(ch.Scheduled_Start_Date) Scheduled_year,MONTH(ch.Scheduled_Start_Date) AS Scheduled_month,
				...
				LEFT OUTER JOIN (SELECT CRQ FROM  dbo.vw_Change_Approval_Details LEFT OUTER JOIN [SM_Change_Researching_DB].dbo.tbl_Change_Approvers_Merged ap ON CRQ = ap.Infrastructure_Change_ID where CRQ_Type = 'Normal' AND Status NOT IN ('Request For Authorization','Cancelled','Rejected')  
					AND (
