...
/* Specify the server and connection string attributes. */
		...
		$sql = "WITH Temp_Late_Approvals AS (
				...
				AND DATEPART(HOUR, ch.[First Approval Date])  > 14 
				AND [First On Behalf of] != 'CM_Eval'
				) 
				SELECT TOP 10 Approver, count(*) CRQnum
...
$graph->title->Set("Requesters' Managers approving after 2:00 PM");
