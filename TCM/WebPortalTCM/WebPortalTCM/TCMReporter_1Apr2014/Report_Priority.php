<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT Priority,count(*) CRQnum FROM dbo.tbl_Change_Change_Merged 
				WHERE CRQ_Type = 'Normal'
				AND Change_Request_Status NOT IN ('Draft','Request For Authorization')
				AND [Support Company] IN ('Regional Operations','Network Engineering','Products & Services Delivery','Service Management','IT Operations')
				GROUP BY Priority ORDER BY Priority DESC;";
		
		$sql0 = "SELECT Priority,count(*) CRQnum FROM dbo.vw_Change_Approval_Details 
				WHERE CRQ_Type = 'Normal'
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Priority of Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
