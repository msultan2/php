<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT CASE Status WHEN 'Scheduled' THEN 'Authorized'
				...
				GROUP BY CASE Status WHEN 'Scheduled' THEN 'Authorized'
											WHEN 'Implementation In Progress' THEN 'Authorized'
											WHEN 'Completed' THEN 'Authorized'
											WHEN 'Closed' THEN 'Authorized' 
											WHEN 'Pending' THEN 'Authorized'
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Normal Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"65%",height:"90%"} };          
