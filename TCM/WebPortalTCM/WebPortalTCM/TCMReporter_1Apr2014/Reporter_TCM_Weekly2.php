...
<form method=post action='Reporter_TCM_Weekly2.php'>
	...
	<table>	
		...
		<tr>
			<td><iframe src="Report_noCM.php?from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" scrolling=no frameborder=0 width="350px" height="550px"></iframe></td>
			<td><iframe src="Report_noCM_Teams.php?from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" scrolling=no frameborder=0 width="350px" height="550px"></iframe></td>
		</tr>
		<tr>
			<!--td colspan=2><iframe src="Report_Hany_CRQsTotal.php" frameborder=0 width="1000px" height="100px"></iframe></td-->
		</tr>
		<tr>
			<td><iframe src="Report_IDC_Team2.php?from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" frameborder=0 width="500px" height="550px"></iframe></td>
			<td><iframe src="Report_ExceptionsTeam.php?from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" frameborder=0 width="500px" height="550px"></iframe></td>
			<td><iframe src="Report_IDC_Team2.php?from=<?php echo $getFrom;?>&to=<?php echo $getTo;?>" frameborder=0 width="500px" height="550px"></iframe></td>
		</tr>
	</table>
