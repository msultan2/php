...
$css = "";
	...
	case 50:
				...
				if($_SERVER['PHP_SELF']=="/TCMReporter/Reporter_TeamKPIs.php") $css="class=current"; else $css=""; 
					echo "<li><a href=Reporter_TeamKPIs.php $css>Support Team KPIs<span style='color:yellow'><I>  New</I></span></a></li>";
				break;
    case 100:
				echo 	'<li><a href="#" class="menu">Daily CAB Meeting</a></li>';
				...
				//if($_SERVER['PHP_SELF']=="/TCMReporter/CRQ_Attendance.php") $css="class=current"; else $css=""; 
				//echo "<li><a href=CRQ_Attendance.php $css>CAB Attendance</a></li>";
				//if($_SERVER['PHP_SELF']=="/TCMReporter/CRQ_Guidelines.php") $css="class=current"; else $css=""; 
				//echo "<li><a href=CRQ_Guidelines.php $css>CAB Guidelines</a></li>";
