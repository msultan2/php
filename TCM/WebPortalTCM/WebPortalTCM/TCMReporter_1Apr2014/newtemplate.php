...
<div id="topsection">
	...
	<table width="100%" height="80px">
		...
		<tr>
			...
			<td align=left width='245px'><h1><U style="color:darkgray"><span style="color:darkgray">VETO </span><span style="color:#B40404">Reporter</span></U></h1></td>
			<td width='1250px'></td>
		</tr>
...
<?php if($_SERVER['PHP_SELF']=="/TCMReporter/home.php") echo "<li class=selected>"; else echo "<li>"; ?>
	<a href="home.php" style="margin-left: 200px"><span>Home</span></a></li>
<?php if($_SERVER['PHP_SELF']=="/TCMReporter/Reporter_TeamKPIs.php") echo "<li class=selected>"; else echo "<li>"; ?>
	<a href="Reporter_TeamKPIs.php"><span>Team KPIs</span></a></li>	
