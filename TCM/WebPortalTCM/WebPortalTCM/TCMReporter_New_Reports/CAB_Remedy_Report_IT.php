...
<table><tr>
	...
	<tr><td><textarea name="query" cols="125" rows="25">
		<?php 
			$sql = "SELECT DISTINCT CRQ FROM dbo.vw_Change_Daily_CAB WHERE status = 'Request For Authorization' AND ChangeFor = 'IT' ;";
			...
			while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
				...
				if ($count == 0) 
					$strCRQ = "'Status*' = ".'"Request For Authorization"'. " AND 'Change For' = ".'"IT"'." AND ( 'Change ID*+' = ".'"'. $row['CRQ'] .'" ';
				else
