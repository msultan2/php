<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT ap.Support_Organization,count(*) CRQnum FROM dbo.vw_Change_Approval_Details ap
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		var data = google.visualization.arrayToDataTable([           
			['Team', 'Number of Emergency Changes'],           
		...
		//drawPieChart
		var options = {           title: 'Emergency Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"60%",height:"90%"} };          
