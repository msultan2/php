<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT timeFrame.Description,count(*) CRQnum 
				FROM dbo.vw_Change_Approval_Details ch LEFT OUTER JOIN dbo.tbl_Change_Execution_TimeFrame timeFrame ON ch.Execution_Time_Frame = timeFrame.ID
				...
				GROUP BY timeFrame.Description ORDER BY CRQnum DESC;";
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		var data = google.visualization.arrayToDataTable([           
			['Execution Time Frame', 'Number of Changes'],           
		...
		//drawPieChart
		var options = {           title: 'Execution Time Frame'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
