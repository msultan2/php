...
<script type="text/javascript">       
	...
	function drawAll() {         
		...
		var myChart = new google.visualization.ChartWrapper({           'chartType': 'PieChart', 'containerId': 'chart_div',           'options': {             'width': 600,             'height': 350,             'pieSliceText': 'percent',      'sliceVisibilityThreshold':1/25,       'legend': 'right'           }         });          
