<?php
		...
		$sql = "SELECT inc.Priority, count(*) INCnum
		...
		while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
			array_push($data_Desc,$row['Priority']);
...
<script type="text/javascript">       
	...
	function draw_ChangeTypes() {         
		var data = google.visualization.arrayToDataTable([           
			['Priority of Incident', 'Number of IDCs'],           
		...
		//drawPieChart
		var options = {           title: 'IT IDCs Priority'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
