...
<table><tr><td width="95%"><div class="body_text">Authorized Normal Changes per Requesting Deptartment </div></td>
<td align=right >
<?php 
		...
		echo '<a href="excel.php?name=Monthly_Normal_Requested&query='.$sql_encoded.'">';
	?>
