<?php
	...
	/* Specify the server and connection string attributes. */
		...
		$sql = "SELECT Risk_Level,count(*) CRQnum FROM dbo.vw_Change_Approval_Details 
		...
		while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
			array_push($data_Desc,$row['Risk_Level']);
...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		//drawPieChart
		var options = {           title: 'Risk Level of Changes'  , is3D: true  , chartArea:{left:20,top:20,width:"90%",height:"90%"} };          
