...
<script type="text/javascript">       
	...
	function draw_ChangeFor(){
		...
		var data_table = google.visualization.arrayToDataTable([           
			['Team', 'Normal Changes','Standard Changes','Total'],           
			<?php for($i=0;$i<count($data_Team); $i++) {             
		...
		var options_new = { 	title: 'NW CRQs Authorized per Team'  , 
					...
					series:{0:{type:"bars",color:"green"},1:{targetAxisIndex:2, type:"bars", color:"royalblue"}}, 
					vAxes:{2:{title:'Standard Changes',maxValue:300,gridlines:{count:7}}},
