...
<div id="content">
	<div class="razd_lr">
		<div id="right">
			...
			<h1>SMS Tools:</h1>
			<div style="height:15px;"></div>
			Use <a href="SMS_tools.php" title="SMS Tools">SMS Tools</a> to Approve, Reject, ..etc Changes.
			<div style="height:15px;"></div>
			<center><a href="SMS_tools.php" title="SMS Tools"><img src="images/iPhone1_red.jpg"/></a></center>
			<div class="razd_h"></div>
