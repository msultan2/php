		...
		<h1>PA Calendar:</h1>
			...
			<?php	  
				...
				echo "<table cellspacing='0' cellpadding='0' align=center width='100' border='1'>
						<tr>
							<td align=center ><font size='3' face='Tahoma'> <a href='calendar.php?prm=$m&chm=-1'><</a></td>
				...
				for($i=1;$i<=$no_of_days;$i++){
					...
					for($pa=0; $pa < $num_PA; $pa++){
						if(strpos($calendar[$pa],$thisDate)){
							list($pa_desc,$date,$pa_impact,$pa_site)=split(',',$calendar[$pa],4);

							echo "<table class=blue width=90% >";						
